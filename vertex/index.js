...
import { componentState, meta as componentStateMeta } from './componentState/index.js';
...
export function vertex({ g, diagnostics }) {
  return {
    ...
    componentState: componentState({ g, diagnostics }),
  };
}
export const meta = {
  ...
  componentState: componentStateMeta,
}
